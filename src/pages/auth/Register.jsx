    ...
    <>
      ...
      <div className="reg-root">
        ...
        <div className="reg-left">
          <img src="https://images.unsplash.com/photo-1616137148650-4aa14051b5c4?w=1200&q=80" alt="Servica signup experience" />
          <div className="reg-left-overlay">
            <h2 className="reg-left-title">Create Your <em>Account</em><br />with Servica</h2>
            <ul className="reg-perks">
              {["500+ Ready Projects", "Transparent Pricing", "Instant Live Demo Access", "Expert Support"].map(p => (
        ...
        <div className="reg-right">
          <div className="reg-form-wrap">
            ...
            <p className="reg-sub">Start your journey with ready-to-build digital solutions.</p>
