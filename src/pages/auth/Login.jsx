    ...
    <>
      ...
      <div className="auth-root">
        ...
        <div className="auth-left">
          <img src="https://images.unsplash.com/photo-1600566753190-17f0baa2a6c3?w=1200&q=80" alt="Servica dashboard access" />
          <div className="auth-left-overlay">
            <p className="auth-left-quote">"Access your dashboard, track projects, and manage your services."</p>
            <p className="auth-left-sub">Built for businesses growing digitally.</p>
          </div>
        </div>
        ...
        <div className="auth-right">
          <div className="auth-form-wrap">
            ...
            <p className="auth-subtitle">Access your dashboard, track projects, and manage your services.</p>
