...
const STYLES = `
  ...
  .ct-step { display: flex; gap: 14px; position: relative; padding-bottom: 20px; }
  ...
  .ct-step-line { flex: 1; width: 1px; background: var(--border); margin: 6px 0 0; }
...
const TRUST_ITEMS = [
  { icon: <Clock size={14} strokeWidth={2} />, text: <><strong>Fast</strong> turnaround</> },
  { icon: <Shield size={14} strokeWidth={2} />, text: <><strong>Free</strong> consultation</> },
  { icon: <Star size={14} strokeWidth={2} />, text: <><strong>4.9★</strong> average rating</> },
  { icon: <CheckCircle size={14} strokeWidth={2} />, text: <><strong>500+</strong> ready projects</> },
];

const WHY_ITEMS = [
  { icon: <Clock size={16} color="var(--green)" strokeWidth={2} />, title: "Fast Turnaround", desc: "Delivery in days, not months" },
  { icon: <Shield size={16} color="var(--green)" strokeWidth={2} />, title: "Transparent Pricing", desc: "No hidden cost" },
  { icon: <Star size={16} color="var(--green)" strokeWidth={2} />, title: "Expert Team", desc: "Developers + Designers" },
  { icon: <CheckCircle size={16} color="var(--green)" strokeWidth={2} />, title: "7-Day Risk-Free Guarantee", desc: "Unlimited revisions with dependable support" },
];

const PROCESS_STEPS = [
  { title: "Browse & Select a Service", desc: "Pick the ready-to-launch service that fits your business goal.", icon: "1" },
  { title: "View Live Demo", desc: "Preview how the solution works before you move ahead.", icon: "2" },
  { title: "Submit Your Requirements", desc: "Share your idea, features, and customization needs with us.", icon: "3" },
  { title: "Schedule a Meeting", desc: "Connect with our experts to align on tech, strategy, and scope.", icon: "4" },
  { title: "Development Begins", desc: "Our team starts building and customizing your chosen solution.", icon: "5" },
  { title: "Delivery & Support", desc: "Receive your completed product with revisions and post-delivery support.", icon: "6" },
];
    ...
    <>
      ...
      <div className="ct-root">
        <div className="ct-hero">
          <p className="ct-hero-eyebrow">Consultation</p>
          <h1 className="ct-hero-title">
            Book a <em>Consultation</em><br />Meeting
          </h1>
          <p className="ct-hero-sub">
            Tell us your idea — we'll help you turn it into a working product with the right tech and strategy.
          </p>
        </div>
        ...
        <div className="ct-body">
            ...
            {submitted ? (
              <div className="ct-success">
                ...
                <p className="ct-success-sub">
                  Thank you — our team will reach out shortly to confirm your consultation details.
                </p>
              ...
              <>
                <h2 className="ct-form-title">Schedule Your Free Consultation</h2>
                <p className="ct-form-sub">Fill in your details and we'll help shape the right solution for your project.</p>
                ...
                <form onSubmit={handleSubmit}>
                  <div className="ct-grid">
                    <div className="ct-field">
                      ...
                      <div className="ct-input-wrap">
                        ...
                        <input name="clientName" value={formData.clientName} onChange={handleChange} type="text" placeholder="John Doe" required className="ct-input" />
                      </div>
                    </div>
                    ...
                    <div className="ct-field">
                      ...
                      <div className="ct-input-wrap">
                        ...
                        <input name="phone" value={formData.phone} onChange={handleChange} type="tel" placeholder="+91 9876543210" required className="ct-input" />
                      </div>
                    </div>
                    ...
                    <div className="ct-field">
                      ...
                      <div className="ct-input-wrap">
                        ...
                        <input name="email" value={formData.email} onChange={handleChange} type="email" placeholder="you@example.com" required className="ct-input" />
                      </div>
                    </div>
                    ...
                    <div className="ct-field">
                      ...
                      <div className="ct-input-wrap">
                        ...
                        <input name="subject" value={formData.subject} onChange={handleChange} type="text" placeholder="Website, app, ERP, branding..." required className="ct-input" />
                      </div>
                    </div>
                    ...
                    <div className="ct-field">
                      ...
                      <div className="ct-input-wrap">
                        ...
                        <input name="DOM" value={formData.DOM} onChange={handleChange} type="date" min={new Date().toISOString().split("T")[0]} className="ct-input" />
                      </div>
                    </div>
                    ...
                    <div className="ct-field">
                      ...
                      <div className="ct-toggle-wrap">
                        ...
                        >
                          <MapPin size={14} strokeWidth={2} /> Offline
                        </button>
                      </div>
                    </div>
                    ...
                    {formData.meetingType === "Offline" && (
                      <div className="ct-field ct-full">
                        ...
                        <div className="ct-input-wrap">
                          ...
                          <input name="location" value={formData.location} onChange={handleChange} type="text" placeholder="Address or area" className="ct-input" />
                        </div>
                      </div>
                    )}
                    ...
                    <div className="ct-field ct-full">
                      ...
                      <textarea
                        ...
                        placeholder="Tell us about your idea, goals, and any specific requirements..."
                        rows={5}
                  ...
                  <div className="ct-submit-row">
                    <p className="ct-submit-note">
                      Transparent pricing, expert guidance, and a risk-free consultation process.
                    </p>
          ...
          <div className="ct-sidebar">
            <div className="ct-info-card">
              <h3 className="ct-info-title">Why Work With Us?</h3>
              <p className="ct-info-sub">
                We help businesses move from idea to delivery with clarity, speed, and expert execution.
              </p>
                ...
                {PROCESS_STEPS.map((step, i) => (
                  <div key={i} className="ct-step">
                    <div className="ct-step-left">
                      <div className="ct-step-num">{step.icon}</div>
                      <div className="ct-step-line" />
                    </div>
                    <div style={{ paddingTop: 3, paddingBottom: 20 }}>
                      <div className="ct-step-title">{step.title}</div>
                      <div className="ct-step-desc">{step.desc}</div>
                    </div>
                  </div>
                ))}
              </div>
