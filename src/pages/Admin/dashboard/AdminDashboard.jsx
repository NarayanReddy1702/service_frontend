...
export default function AdminDashboard() {
  ...
  const statCards = [
    ...
    { icon: <ClipboardList size={18} />, val: stats.meetings,   lbl: "Meetings Booked",  color: "#f59e0b", bg: "rgba(245,158,11,0.12)" },
        ...
        <div className="db-grid2">
          ...
          <div className="db-card">
            <div className="db-card-head">
              <div>
                <span className="db-card-title">Recent Contact Requests</span>
                <div className="db-m-sub">Track latest leads and customer interactions in real-time.</div>
              </div>
            </div>
          ...
          <div className="db-card">
            <div className="db-card-head">
              <span className="db-card-title">Your Active Services</span>
            </div>
