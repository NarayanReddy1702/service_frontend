      ...
      <section className="cta-root">
        ...
        <div className="cta-inner">
          ...
          <h2 className="cta-heading">
            Launch the Right Digital Solution <br />
            for <em>Your Business</em>
          </h2>

          <p className="cta-sub">
            Explore ready-to-build services, preview live demos, and connect with experts to move your project forward.
          </p>
          ...
          <div className="cta-proof">
            <div className="cta-proof-item">
              ...
              <div className="cta-proof-label">Ready Projects</div>
            </div>
